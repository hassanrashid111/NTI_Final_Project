...
# Serve presentation deck, sample datasets & Frontend SPA
PRES_DIR = PROJECT_ROOT / "04_Presentation"
if PRES_DIR.exists():
    app.mount("/presentation", StaticFiles(directory=str(PRES_DIR), html=True), name="presentation")
