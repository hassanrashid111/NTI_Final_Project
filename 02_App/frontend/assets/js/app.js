...
function parseAndProcessCSVText(csvText, datasetName) {
  ...
  if (badge) {
    badge.innerHTML = `<i data-lucide="database" class="w-3.5 h-3.5 text-[#38bdf8] shrink-0"></i><span class="truncate max-w-[200px]">Active: ${datasetName} (${AppState.totalRows.toLocaleString()} rows)</span>`;
